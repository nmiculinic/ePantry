...
ALTER TABLE IF EXISTS ONLY public.food_recipe_item DROP CONSTRAINT IF EXISTS food_recipe_item_recipe_id_fkey;
ALTER TABLE IF EXISTS ONLY public.food_recipe_item DROP CONSTRAINT IF EXISTS food_recipe_item_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.food_diary DROP CONSTRAINT IF EXISTS food_diary_recipe_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.food_recipes DROP CONSTRAINT IF EXISTS food_recipes_pkey;
ALTER TABLE IF EXISTS ONLY public.food_recipe_item DROP CONSTRAINT IF EXISTS food_recipe_item_pkey;
ALTER TABLE IF EXISTS ONLY public.food_diary DROP CONSTRAINT IF EXISTS food_diary_pkey;
ALTER TABLE IF EXISTS public.items ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.food_recipes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.food_recipe_item ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.food_diary ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public.food_diary_id_seq OWNER TO postgres;
...
ALTER TABLE public.food_recipe_item OWNER TO postgres;
...
ALTER TABLE public.food_recipe_item_id_seq OWNER TO postgres;
...
ALTER TABLE public.food_recipes OWNER TO postgres;
...
ALTER TABLE public.food_recipes_id_seq OWNER TO postgres;
...
ALTER TABLE ONLY public.food_diary ALTER COLUMN id SET DEFAULT nextval('public.food_diary_id_seq'::regclass);
...
ALTER TABLE ONLY public.food_recipe_item ALTER COLUMN id SET DEFAULT nextval('public.food_recipe_item_id_seq'::regclass);
...
ALTER TABLE ONLY public.food_recipes ALTER COLUMN id SET DEFAULT nextval('public.food_recipes_id_seq'::regclass);
...
INSERT INTO public.food_diary VALUES (2, 3, '2020-02-14 19:48:16', NULL);
INSERT INTO public.food_diary VALUES (3, 3, '2020-02-13 19:48:40', NULL);
INSERT INTO public.food_diary VALUES (4, 4, '2020-02-13 15:48:46', NULL);
...
INSERT INTO public.food_recipe_item VALUES (1, 3, 1, 0.1, NULL);
INSERT INTO public.food_recipe_item VALUES (2, 3, 2, 0.05, NULL);
INSERT INTO public.food_recipe_item VALUES (3, 4, 1, 0.6, NULL);
INSERT INTO public.food_recipe_item VALUES (4, 4, 3, 0.2, NULL);
...
INSERT INTO public.food_recipes VALUES (3, 'mrkva i avokado', 1, 'dorucak', 'narezi mrvu i dodaj avokado');
INSERT INTO public.food_recipes VALUES (4, 'mrkva i tuna', 2, 'rucak', 'pomijesaj mrvku i tunu');
...
INSERT INTO public.items VALUES (1, 'mrkva', 'mrkva notes', NULL, NULL, NULL, NULL);
INSERT INTO public.items VALUES (2, 'avokado', 'avokado notes', NULL, NULL, NULL, NULL);
INSERT INTO public.items VALUES (3, 'tuna', 'tuna notes', NULL, NULL, NULL, NULL);
